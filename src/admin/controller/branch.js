...
export default class extends Base {
    ...
    async indexAction() {
        ...
        return this.display('branch/index.html');
    }
    ...
    async addAction(){
        ...
        if(this.isPost()){
            ...
            return this.display('branch/form.html');
        }
    }
    ...
    getStatus(status){
        const BRANCH_STATUS = this.BRANCH_STATUS;
        for(let i of BRANCH_STATUS['extra']){
